...
import { BrainCircuit, Link2, ChevronDown, Cog, Disc3, FileMusic, FileText, FolderOpen, Info, Keyboard, Layers, LayoutTemplate, MessageSquareOff, MicOff, Save, ScrollText, Sparkles, Star, Users, Wand2, WandSparkles, Zap } from "lucide-react";
